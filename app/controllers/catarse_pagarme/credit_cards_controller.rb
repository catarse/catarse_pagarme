        ...
        events: [
          {
            ...
            address: {
              country: "Brasil",
              state: project.user.address.address_state,
              city: project.user.address.address_city,
              zipcode: project.user.address.address_zip_code,
              neighborhood: project.user.address.address_neighbourhood,
              street: project.user.address.address_street,
              street_number: project.user.address.address_number,
              complementary: project.user.address.address_complement,
              latitude: 0.0,
              longitude: 0.0
            },
            ticket_types: [
